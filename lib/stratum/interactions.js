...
const errors = {
    ...
    "TOOMANY_SHARES": { code: 31, message: 'Too many shares submitted in a row, wait for difficulty adjustment or use another port with a higher starting difficulty' },
